const marsText =
  "So my work experience starts as freelance doing Python scraping for a local enterprice. I worked with a friend using Python 🐍 and scrapping local news about houses and rents.";
